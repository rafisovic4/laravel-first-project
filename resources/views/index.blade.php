            ...
            <article class="post">
                <header>
                    ...
                    <div class="meta">
                        ...
                        <a href="{{route('user', $article->author_id)}}" class="author"><span class="name">{{$article->author()->username}}</span>
                            <img src="{{$article->author()->image_url}}" alt=""/></a>
                    </div>
                </header>
                ...
                <footer>
                    ...
                    <ul class="stats">
                        ...
                        <li><a href="#" class="icon fa-comment">{{$article->category()->name}}</a></li>
                    </ul>
                </footer>
            </article>
        @endforeach
